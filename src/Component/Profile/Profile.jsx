...
//     queryKey:["userInfo"],
//     queryFn:()=>{
//       const result = axios.get(`http://localhost:3000/user/${user.email}`)
//       return result
//     }
//   })
...
//         {/* Header */}
//         <div className="bg-slate-800 p-6 flex items-center gap-5">
//           <img
...
//             <p className="text-sm opacity-90 capitalize">Role:{profile?.role}</p>
...
//               </p>
//               <p>
//                 <span className="font-medium text-gray-600">Name:</span> {profile?.name}
//               </p>
//               <p>
