...
//         <caption className="text-center text-xl font-bold mb-10">
//           This is My Loan
//         </caption>
...
//               Status
//             </th>
//             <th className="px-6 py-3 text-left text-sm font-semibold pl-25">
//               Actions
//             </th>
//           </tr>
//         </thead>
...
//               <td className="px-6 py-4 font-medium text-gray-800">{loan._id}</td>
...
//                   <button className="px-3 py-1.5 text-sm rounded-md bg-blue-100 text-blue-700 hover:bg-blue-200">
//                     View
//                   </button>
//                   <button className="px-3 py-1.5 text-sm rounded-md bg-red-100 text-red-700 hover:bg-red-200">
//                     Cancel
//                   </button>
